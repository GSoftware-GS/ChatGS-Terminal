    ...
    if personaje == "homer":
        ...
        return [
            ...
            },
            {
                ...
                f"Name: {homer['nombre']} \n"
                f"Age: {homer['edad']} \n"
                f"Occupation: {homer['ocupacion']} \n"
                f"Marital Status: {homer['estado_civil']} \n"
                f"Children: {', '.join([child['nombre'] for child in homer['hijos']])} \n"
                f"Famous Phrases: {', '.join(homer['frases_famosas'])} \n"
                f"Intelligence: {homer['personalidad']['inteligencia']} \n"
                f"Perseverance: {homer['personalidad']['perseverancia']} \n"
                f"Generosity: {homer['personalidad']['generosidad']} \n"
                f"Amiability: {homer['personalidad']['amabilidad']} \n"
                f"Hobbies: {', '.join(homer['personalidad']['hobbies'])} \n"
                f"Fears: {', '.join(homer['personalidad']['miedos'])} \n",
            },
        ]
